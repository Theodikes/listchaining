...
from types import CodeType, MappingProxyType, NoneType, TracebackType
from typing import (
    IO,
    AbstractSet,
    Any,
...
_R = TypeVar("_R")  # Function result
_TR = TypeVar("_TR") # Temp result (result of inner function or of current iterating cycle)
_S = TypeVar("_S")
_T1 = TypeVar("_T1")
_T2 = TypeVar("_T2")
_T3 = TypeVar("_T3")
...
class list(MutableSequence[_T], Generic[_T]):
    ...
    def last_index_of(self, value: _T, from_index: SupportsIndex = ...) -> int: ...
    def count(self, __value: _T) -> int: ...
    def insert(self, __index: SupportsIndex, __object: _T) -> None: ...
    def remove(self, __value: _T) -> None: ...
    def reverse(self) -> None: ...
    def reversed(self) -> list[_T]: ...
    def flat(self, depth: Union[int, float] = ...) -> list[_T]: ...
    def join(self, delimiter: str, cast_types: bool = ...) -> str: ...
    def concat(self, *args: Any, expand_strings: bool = ...) -> list[_T]: ...
    def slice(self, start: Optional[int] = ..., end: Optional[int] = ...) -> list[_T]: ...
    def includes(self, element: _T) -> bool: ...
    def entries(self) -> list[tuple[int, _T]]: ...
    def fill(self, __value: _R, start: int = ..., end: Optional[int] = ...) -> list[Union[_R, _T]]: ...
    def keys(self) -> list[int]: ...
    def to_string(self) -> str: ...
    def copy_within(self, target: int, start: int = ..., end: Optional[int] = ...) -> list[_T]: ...
    @overload
    def sorted(*, key: None = ..., reverse: bool = ...) -> list[SupportsLessThanT]: ...
    @overload
    def sorted(*, key: Callable[[_T], SupportsLessThan], reverse: bool = ...) -> list[_T]: ...
    @overload
    def map(self, func: Callable[[_T], _TR]) -> list[_TR]: ...
    @overload
    def map(self, func: Callable[[_T, int], _TR]) -> list[_TR]: ...
    @overload
    def map(self, func: Callable[[_T, int, list[_T]], _TR]) -> list[_TR]: ...
    @overload
    def filter(self, func: Callable[[_T], bool]) -> list[_R]: ...
    @overload
    def filter(self, func: Callable[[_T, int], bool]) -> list[_R]: ...
    @overload
    def filter(self, func: Callable[[_T, int, list[_T]], bool]) -> list[_R]: ...
    @overload
    def foreach(self, func: Callable[[_T], None]) -> None: ...
    @overload
    def foreach(self, func: Callable[[_T, int], None]) -> None: ...
    @overload
    def foreach(self, func: Callable[[_T, int, list[_T]], None]) -> None: ...
    @overload
    def find(self, func: Callable[[_T], bool]) -> _R: ...
    @overload
    def find(self, func: Callable[[_T, int], bool]) -> _R: ...
    @overload
    def find(self, func: Callable[[_T, int, list[_T]], bool]) -> _R: ...
    @overload
    def find_index(self, func: Callable[[_T], bool]) -> int: ...
    @overload
    def find_index(self, func: Callable[[_T, int], bool]) -> int: ...
    @overload
    def find_index(self, func: Callable[[_T, int, list[_T]], bool]) -> int: ...
    @overload
    def some(self, func: Callable[[_T], bool]) -> bool: ...
    @overload
    def some(self, func: Callable[[_T, int], bool]) -> bool: ...
    @overload
    def some(self, func: Callable[[_T, int, list[_T]], bool]) -> bool: ...
    @overload
    def every(self, func: Callable[[_T], bool]) -> bool: ...
    @overload
    def every(self, func: Callable[[_T, int], bool]) -> bool: ...
    @overload
    def every(self, func: Callable[[_T, int, list[_T]], bool]) -> bool: ...
    @overload
    def reduce(self, func: Callable[[_TR, _T], _TR]) -> _R: ...
    @overload
    def reduce(self, func: Callable[[_TR, _T, int], _TR]) -> _R: ...
    @overload
    def reduce(self, func: Callable[[_TR, _T, int, list[_T]], _TR]) -> _R: ...
    @overload
    def reduce(self, func: Callable[[_TR, _T], _TR], initial: _TR) -> _R: ...
    @overload
    def reduce(self, func: Callable[[_TR, _T, int], _TR], initial: _TR) -> _R: ...
    @overload
    def reduce(self, func: Callable[[_TR, _T, int, list[_T]], _TR], initial: _TR) -> _R: ...
    @overload
    def reduce_right(self, func: Callable[[_TR, _T], _TR]) -> _R: ...
    @overload
    def reduce_right(self, func: Callable[[_TR, _T, int], _TR]) -> _R: ...
    @overload
    def reduce_right(self, func: Callable[[_TR, _T, int, list[_T]], _TR]) -> _R: ...
    @overload
    def reduce_right(self, func: Callable[[_TR, _T], _TR], initial: _TR) -> _R: ...
    @overload
    def reduce_right(self, func: Callable[[_TR, _T, int], _TR], initial: _TR) -> _R: ...
    @overload
    def reduce_right(self, func: Callable[[_TR, _T, int, list[_T]], _TR], initial: _TR) -> _R: ...
    @overload
